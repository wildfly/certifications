...
----
Date:  Tue Jul 23 01:04:02 PM CEST 2024
Product Name:  WildFly
Product Version: WildFly 33.0.0.Final
...
Java SE provider and Version tested with:  OpenJDK 11.0.23 17.0.11 21.0.3 
OS version: Linux 6.5.0-44-generic GNU/Linux
----
...
https://github.com/wildfly/certifications/blob/MP6.1/WildFly_33.0.0.Final/microprofile-6.1/microprofile-6.1-selected-specifications-certification.adoc[WildFly 33.0.0.Final TCK results]

=== TCK Test Results

- link:microprofile-6.1-selected-specifications-jdk-11.0.23.adoc[Selected TCKs Test Results JDK 11.0.23]
- link:microprofile-6.1-selected-specifications-jdk-17.0.11.adoc[Selected TCKs Test Results JDK 17.0.11]
- link:microprofile-6.1-selected-specifications-jdk-21.0.3.adoc[Selected TCKs Test Results JDK 21.0.3]
