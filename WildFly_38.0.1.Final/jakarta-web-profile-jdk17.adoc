...
Product Name, Version: WildFly 38.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_38.0.1.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 38.0.1.Final TCK results]
