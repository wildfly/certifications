...
----
Date:  May 19, 2022
Product Name, Version: WildFly Preview 26.1.1.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_Preview_26.1.1.Final/jakarta-full-platform.adoc#tck-results[WildFly 26.1.1.Final TCK results]
