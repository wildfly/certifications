...
----
Date:  July 20, 2023
Product Name, Version: WildFly 29.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_29.0.0.Final/jakarta-full-platform-jdk11.adoc#tck-results[WildFly 29.0.0.Final TCK results]
