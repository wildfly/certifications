...
----
Date:  October 5, 2021
Product Name, Version: WildFly Preview 25.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_25.0.0.Final/jakarta-full-platform.adoc#tck-results[WildFly 25.0.0.Final TCK results]
