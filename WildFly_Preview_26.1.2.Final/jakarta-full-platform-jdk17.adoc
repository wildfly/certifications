...
----
Date:  August 31, 2022
Product Name, Version: WildFly Preview 26.1.2.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_Preview_26.1.2.Final/jakarta-full-platform.adoc#tck-results[WildFly 26.1.2.Final TCK results]
