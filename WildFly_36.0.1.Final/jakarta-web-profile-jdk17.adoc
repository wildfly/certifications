...
----
Date:  May 15, 2025
Product Name, Version: WildFly 36.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_36.0.1.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 36.0.1.Final TCK results]
