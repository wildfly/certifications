...
----
Date:  Fri May 16 10:28:27 AM CEST 2025
Product Name:  WildFly
Product Version: WildFly 36.0.1.Final
...
Java SE provider and Version tested with:  OpenJDK 17.0.15 21.0.7 
OS version: Linux 6.8.0-59-generic GNU/Linux
----
...
- link:microprofile-7.0-jdk-17.0.15.adoc[Selected TCKs Test Results JDK 17.0.15]
- link:microprofile-7.0-jdk-21.0.7.adoc[Selected TCKs Test Results JDK 21.0.7]
