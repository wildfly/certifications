...
Product Name, Version: WildFly 38.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_38.0.0.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 38.0.0.Final TCK results]
