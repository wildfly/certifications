...
Product Version: WildFly 26.0.0.Final
...
https://github.com/wildfly/certifications/blob/MP4.1/WildFly_26.0.0.Final/microprofile-4.1/microprofile-full-platform.adoc[WildFly 26.0.0.Final TCK results]
