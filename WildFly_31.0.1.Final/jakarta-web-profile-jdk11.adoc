...
Product Name, Version: WildFly 31.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_31.0.1.Final/jakarta-web-profile-jdk11.adoc#tck-results[WildFly 31.0.1.Final TCK results]
