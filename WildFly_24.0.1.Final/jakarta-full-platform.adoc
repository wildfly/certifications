...
----
Date:  July 27, 2021
Product Name, Version: WildFly Preview 24.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_24.0.1.Final/jakarta-full-platform.adoc#tck-results[WildFly 24.0.1.Final TCK results]
