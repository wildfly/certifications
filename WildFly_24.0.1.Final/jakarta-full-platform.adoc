...
Product Version: WildFly 24.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_24.0.1.Final/jakarta-full-platform.adoc[WildFly 24.0.1.Final TCK results]
