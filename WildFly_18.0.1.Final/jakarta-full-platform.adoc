...
Product Version: WildFly 18.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_18.0.1.Final/jakarta-full-platform.adoc[WildFly 18.0.1.Final TCK results]
