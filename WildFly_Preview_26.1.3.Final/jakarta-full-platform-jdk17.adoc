...
Product Name, Version: WildFly Preview 26.1.3.Final
...
Java SE provider and Version tested with:  OpenJDK 64-Bit Server VM 21.9 (build 17.0.3+6-LTS, mixed mode, sharing)
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_Preview_26.1.3.Final/jakarta-full-platform.adoc#tck-results[WildFly 26.1.3.Final TCK results]
...
Download URL & SHA-256
https://download.eclipse.org/jakartaee/xml-binding/3.0/jakarta-xml-binding-tck-3.0.2.zip[jakarta-xml-binding-tck-3.0.2.zip], a1241e3ea8059a267ee5c93ded50aadbcc9b11d17cce2f2a8ad56f16449bda31 ]
