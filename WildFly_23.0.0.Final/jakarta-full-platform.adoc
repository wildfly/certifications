...
Product Version: WildFly 23.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_23.0.0.Final/jakarta-full-platform.adoc[WildFly 23.0.0.Final TCK results]
