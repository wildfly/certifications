...
----
Date:  Fri May 31 04:54:41 PM CEST 2024
Product Name:  WildFly
Product Version: WildFly 32.0.1.Final
...
Java SE provider and Version tested with:  OpenJDK 11.0.23 17.0.7 21.0.2 
OS version: Linux 6.8.4-200.fc39.x86_64 GNU/Linux
----
...
https://github.com/wildfly/certifications/blob/MP6.1/WildFly_32.0.1.Final/microprofile-6.1/microprofile-6.1-selected-specifications-certification.adoc[WildFly 32.0.1.Final TCK results]
