...
https://github.com/wildfly/certifications/blob/EE10/WildFly_27.0.0.Beta1/jakarta-core-jdk11.adoc#jakarta-core-profile-1000-tck-java-se-11-results[WildFly 27.0.0.Beta1 TCK results]
