...
https://github.com/wildfly/certifications/blob/EE10/WildFly_EE_10_41.0.0.Final/jakarta-full-platform-jdk21.adoc#tck-results[WildFly EE 10 41.0.0.Final TCK results]
...
TCK result summary:
----
Tests run: 258, Failures: 0, Errors: 0
