...
https://github.com/wildfly/certifications/blob/EE10/WildFly_EE_10_41.0.0.Final/jakarta-core-jdk21.adoc#tck-results[WildFly EE 10 41.0.0.Final TCK results]
...
Tests run: 2647, Failures: 0, Errors: 0, Skipped: 130
