...
Product Version: WildFly 23.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_23.0.1.Final/jakarta-full-platform.adoc[WildFly 23.0.1.Final TCK results]
