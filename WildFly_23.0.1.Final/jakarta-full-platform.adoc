...
Product Description: An implementation of the Jakarta EE 9 Full Platform and Web Profile Specifications
...
https://github.com/wildfly/certifications/blob/EE9/WildFly_23.0.1.Final/jakarta-full-platform.adoc#tck-results[WildFly 23.0.1.Final TCK results]
