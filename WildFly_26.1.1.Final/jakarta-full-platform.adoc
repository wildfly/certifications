...
Product Version: WildFly 26.1.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_26.1.1.Final/jakarta-full-platform.adoc[WildFly 26.1.1.Final TCK results]
