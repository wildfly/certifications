...
----
Date:  June 17, 2021
Product Name, Version: WildFly Preview 24.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_24.0.0.Final/jakarta-full-platform.adoc#tck-results[WildFly 24.0.0.Final TCK results]
