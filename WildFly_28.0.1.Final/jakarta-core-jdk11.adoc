...
https://github.com/wildfly/certifications/blob/EE10/WildFly_28.0.1.Final/jakarta-core-jdk11.adoc#jakarta-core-profile-1000-tck-java-se-11-results[WildFly 20.0.1.Final TCK results]
