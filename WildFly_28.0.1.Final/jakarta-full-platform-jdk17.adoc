...
https://github.com/wildfly/certifications/blob/EE10/WildFly_28.0.1.Final/jakarta-full-platform-jdk17.adoc#tck-results[WildFly 28.0.1.Final TCK results]
...
Includes already certified [Eclipse Angus Mail 2.0.1](https://github.com/eclipse-ee4j/angus-mail/releases/tag/2.0.1)
