...
Product Name, Version: WildFly 35.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_35.0.1.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 35.0.1.Final TCK results]
