...
The 16 failing tests were passing but now failing due to reasons mentioned in TCK challenge https://github.com/eclipse-ee4j/jaxb-tck/issues/78 (due to www.w3.org redirect from http to https).
