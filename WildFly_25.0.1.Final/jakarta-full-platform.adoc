...
Product Version: WildFly 25.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_25.0.1.Final/jakarta-full-platform.adoc[WildFly 25.0.1.Final TCK results]
