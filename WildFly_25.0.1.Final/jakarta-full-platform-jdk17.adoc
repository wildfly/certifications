...
Product Name, Version: WildFly Preview 25.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_25.0.1.Final/jakarta-full-platform.adoc#tck-results[WildFly 25.0.1.Final TCK results]
