...
----
Date:  Thu Sep  8 03:46:58 PM CEST 2022
...
OS version: Linux 5.18.13-200.fc36.x86_64 GNU/Linux
----
Specification Name, Version and download URL:
https://download.eclipse.org/microprofile/microprofile-4.1/microprofile-spec-4.1.pdf[MicroProfile 4.1]

Public URL of TCK Results Summary:
https://github.com/wildfly/certifications/blob/MP4.1/WildFly_26.1.2.Final/microprofile-4.1/microprofile-4.1-full-certification.adoc[WildFly 26.1.2.Final TCK results]
