...
----
Date:  Thu Oct 17 11:05:44 PM CEST 2024
Product Name:  WildFly
Product Version: WildFly 34.0.0.Final
...
OS version: Linux 6.8.0-45-generic GNU/Linux
----
...
https://github.com/wildfly/certifications/blob/MP6.1/WildFly_34.0.0.Final/microprofile-6.1/microprofile-6.1-selected-specifications-certification.adoc[WildFly 34.0.0.Final TCK results]
