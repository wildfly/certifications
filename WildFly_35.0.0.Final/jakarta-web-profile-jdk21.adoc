...
----
Date:  January 8, 2025
Product Name, Version: WildFly 35.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_35.0.0.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 35.0.0.Final TCK results]
