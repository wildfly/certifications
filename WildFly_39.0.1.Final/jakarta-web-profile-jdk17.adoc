...
Product Name, Version: WildFly 39.0.1.Final
...
Java SE provider and Version tested with: OpenJDK 64-Bit Server VM (Red_Hat-17.0.16.0.8-1) (build 17.0.16+8-LTS, mixed mode, sharing)
...
https://download.eclipse.org/jakartaee/platform/10/jakarta-jakartaeetck-10.0.6.zip[10.0.6, c3c7e37ceeb4073d3cbf70826563ea1c37ad85fd9ff180f7e3330e2cd73b934d ]

Public URL of TCK Results Summary: 
https://github.com/wildfly/certifications/blob/EE10/WildFly_39.0.1.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 39.0.1.Final TCK results]
