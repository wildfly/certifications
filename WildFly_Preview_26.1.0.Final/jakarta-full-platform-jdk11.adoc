...
----
Date:  April 14, 2022
Product Name, Version: WildFly Preview 26.1.0.Final
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_Preview_26.1.0.Final/jakarta-full-platform.adoc#tck-results[WildFly 26.1.0.Final TCK results]
