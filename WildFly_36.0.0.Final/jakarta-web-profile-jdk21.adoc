...
----
Date:  April 10, 2025
Product Name, Version: WildFly 36.0.0.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_36.0.0.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 36.0.0.Final TCK results]
