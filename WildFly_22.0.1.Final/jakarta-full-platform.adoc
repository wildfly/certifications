...
Product Version: WildFly 22.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE8/WildFly_22.0.1.Final/jakarta-full-platform.adoc[WildFly 22.0.1.Final TCK results]
