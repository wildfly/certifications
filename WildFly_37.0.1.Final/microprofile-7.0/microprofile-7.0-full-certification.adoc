...
----
Date:  Thu Sep  4 12:00:33 PM CEST 2025
Product Name:  WildFly
Product Version: WildFly 37.0.1.Final
...
OS version: Linux 6.8.0-78-generic GNU/Linux
----
Specification Name, Version and download URL:
https://download.eclipse.org/microprofile/microprofile-7.0/microprofile-spec-7.0.pdf[MicroProfile 7.0]

Public URL of TCK Results Summary:
https://github.com/wildfly/certifications/blob/MP7.0/WildFly_37.0.1.Final/microprofile-7.0/microprofile-7.0-full-certification.adoc[WildFly 37.0.1.Final TCK results]

=== TCK Test Results

- link:microprofile-7.0-jdk-17.0.16.adoc[Selected TCKs Test Results JDK 17.0.16]
- link:microprofile-7.0-jdk-21.0.8.adoc[Selected TCKs Test Results JDK 21.0.8]
