...
Product Name, Version: WildFly 37.0.1.Final
...
https://github.com/wildfly/certifications/blob/EE10/WildFly_37.0.1.Final/jakarta-web-profile-jdk17.adoc#tck-results[WildFly 37.0.1.Final TCK results]
