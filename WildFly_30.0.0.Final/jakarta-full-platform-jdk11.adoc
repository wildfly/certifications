...
https://github.com/wildfly/certifications/blob/EE10/WildFly_30.0.0.Final/jakarta-full-platform-jdk11.adoc#tck-results[WildFly 30.0.0.Final TCK results]
...
https://download.eclipse.org/jakartaee/cdi/4.0/cdi-tck-4.0.12-dist.zip[Jakarta Contexts and Dependency Injection 4.0.12 TCK]

SHA-256: `9a78168b529e1a072127e525259bbce9bdc4da2f49deb416363ee2b0a145d14f`
...
Includes already certified [Eclipse Parsson 1.1.4](https://github.com/eclipse-ee4j/parsson/releases/tag/1.1.4)
