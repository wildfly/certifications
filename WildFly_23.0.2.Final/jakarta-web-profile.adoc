...
Product Description: An implementation of the Jakarta EE 9 Web Profile Specification
...
https://github.com/wildfly/certifications/blob/EE9/WildFly_23.0.2.Final/jakarta-web-profile.adoc[WildFly 23.0.2.Final TCK results]
