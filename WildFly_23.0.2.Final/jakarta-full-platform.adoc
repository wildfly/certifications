...
Product Description: An implementation of the Jakarta EE 9.1 Full Platform and Web Profile Specifications
...
https://github.com/wildfly/certifications/blob/EE9.1/WildFly_23.0.2.Final/jakarta-full-platform.adoc#tck-results[WildFly 23.0.2.Final TCK results]
