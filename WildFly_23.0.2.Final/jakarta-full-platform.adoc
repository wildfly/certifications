...
Product Description: An implementation of the Jakarta EE 9 Full Platform Specification
...
https://github.com/wildfly/certifications/blob/EE9/WildFly_23.0.2.Final/jakarta-full-platform.adoc#tck-results[WildFly 23.0.2.Final TCK results]
...
[javatest.batch] Number of Tests with Errors = 0
Test name: jaxrs
[javatest.batch] Completed running 2804 tests.
[javatest.batch] Number of Tests Passed      = 2804
[javatest.batch] Number of Tests Failed      = 0
[javatest.batch] Number of Tests with Errors = 0
